...
void InitBlessingDatabase()
{
	...
	blessingDatabase.emplace(BLESSING_ID::MINOR_ATK_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MINOR_ATK_BUFF, "Minor ATK Boost", "ATK +15%", BLESSING_RARITY::COMMON, nullptr, Game::ATK, 0.15f, "ATK_Minor_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MINOR_DEF_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MINOR_DEF_BUFF, "Minor DEF Boost", "DEF +10%", BLESSING_RARITY::COMMON, nullptr, Game::DEF, 0.10f, "DEF_Minor_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MINOR_HP_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MINOR_HP_BUFF, "Minor HP Boost", "HP +25%", BLESSING_RARITY::COMMON, nullptr, Game::HP, 0.25f, "HP_Minor_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MINOR_CRITRATE_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MINOR_CRITRATE_BUFF, "CRIT Rate Boost", "CRIT Rate +10%", BLESSING_RARITY::COMMON, nullptr, Game::CRIT_RATE, 0.10f, "CRITRATE_Minor_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MINOR_CRITDMG_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MINOR_CRITDMG_BUFF, "CRIT DMG Boost", "CRIT DMG +20% ", BLESSING_RARITY::COMMON, nullptr, Game::CRIT_DAMAGE, 0.20f, "CRITDMG_Minor_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MAJOR_ATK_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MAJOR_ATK_BUFF, "Major ATK Boost", "ATK +50%", BLESSING_RARITY::LEGENDARY, nullptr, Game::ATK, 0.50f, "ATK_Major_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MAJOR_DEF_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MAJOR_DEF_BUFF, "Major DEF Boost", "DEF +25%", BLESSING_RARITY::LEGENDARY, nullptr, Game::DEF, 0.25f, "DEF_Major_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MAJOR_HP_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MAJOR_HP_BUFF, "Major HP Boost", "HP +75%", BLESSING_RARITY::LEGENDARY, nullptr, Game::HP, 0.75f, "HP_Major_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MAJOR_CRITRATE_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MAJOR_CRITRATE_BUFF, "Precision Strike", "CRIT RATE +25%", BLESSING_RARITY::LEGENDARY, nullptr, Game::CRIT_RATE, 0.25f, "CRITRATE_Major_Texture"));

	blessingDatabase.emplace(BLESSING_ID::MAJOR_CRITDMG_BUFF,
		std::make_unique<AttributeBlessing>(BLESSING_ID::MAJOR_CRITDMG_BUFF, "Ferocity", "CRIT DMG +50%", BLESSING_RARITY::LEGENDARY, nullptr, Game::CRIT_DAMAGE, 0.50f, "CRITDMG_Major_Texture"));
	...
	blessingDatabase.emplace(BLESSING_ID::GAIN_CRIT_DMG_ON_CRIT_HIT,
		std::make_unique<TriggerBlessing>(BLESSING_ID::GAIN_CRIT_DMG_ON_CRIT_HIT, "Snowball", "Gain 20% CRIT DMG when landing a critical hit.", BLESSING_RARITY::MYTHICAL,
			nullptr, EventType::DealtCriticalHit,
			[](const EventData& data)
			{
				auto mod = std::make_unique<AttributeModifier>("Snowball", 999, EFFECT_TYPE::ATTRIBUTE_MODIFIER, nullptr, GENERIC_, 0.20f,
